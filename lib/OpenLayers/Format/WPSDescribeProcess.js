    ...
    readers: {
        "wps": {
            ...
            "DefaultValue": function(node, literalData) {
                literalData.defaultValue = node.innerHTML;
            },
            ...
            "Schema": function(node, format) {
                format.schema = this.getChildValue(node);
            },
            "Encoding": function(node, format) {
                format.encoding = this.getChildValue(node);
            }
        },
